...
<div class="div1">
    <button type="button" class="btn btn-outline-primary" onclick="window.location.href = '/index.html'">
        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-box-arrow-in-left" fill="currentColor"
...
<button class="btn btn-info" onclick="window.location.href = '/web/record/all'">Refresh</button>
<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        ...
        <button type="button" class="btn btn-outline-primary"
                onclick="window.location.href = '/web/client/list/sort/id'">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-sort-numeric-down" fill="currentColor"
                 xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4 2a.5.5 0 0 1 .5.5v11a.5.5 0 0 1-1 0v-11A.5.5 0 0 1 4 2z"></path>
                <path fill-rule="evenodd"
                      d="M6.354 11.146a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L4 12.793l1.646-1.647a.5.5 0 0 1 .708 0z"></path>
                <path d="M12.438 7V1.668H11.39l-1.262.906v.969l1.21-.86h.052V7h1.046zm-2.84 5.82c.054.621.625 1.278 1.761 1.278 1.422 0 2.145-.98 2.145-2.848 0-2.05-.973-2.688-2.063-2.688-1.125 0-1.972.688-1.972 1.836 0 1.145.808 1.758 1.719 1.758.69 0 1.113-.351 1.261-.742h.059c.031 1.027-.309 1.856-1.133 1.856-.43 0-.715-.227-.773-.45H9.598zm2.757-2.43c0 .637-.43.973-.933.973-.516 0-.934-.34-.934-.98 0-.625.407-1 .926-1 .543 0 .941.375.941 1.008z"></path>
            </svg>
        </button>
        <#--        <button class="dropdown-item btn btn-danger" onclick="window.location.href = '/web/client/list/sort/name'">Name</button>-->
        <button type="button" class="btn btn-outline-primary"
                onclick="window.location.href = '/web/client/list/sort/name'">
        ...
        <#--        <button class="dropdown-item btn btn-danger" onclick="window.location.href = '/web/client/list/sort/phone'">Phone</button>-->
        <button type="button" class="btn btn-outline-primary"
                onclick="window.location.href = '/web/client/list/sort/phone'">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-phone-fill" fill="currentColor"
                 xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
                      d="M3 2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V2zm6 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"></path>
            </svg>
        </button>
        <button type="button" class="btn btn-outline-primary"
                onclick="window.location.href = '/web/client/list/sort/birthday'">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-calendar2-date" fill="currentColor"
                 xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
        ...
        <#--        <button class="dropdown-item btn btn-danger" onclick="window.location.href = '/web/client/list/sort/birthday'">Birthday</button>-->
    </div>
</div>
                ...
                <td>
                    <button type="button" class="btn btn-outline-danger"
                        ...
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-dash-fill"
                            ...
                            <path fill-rule="evenodd"
                                  d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm5-.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5z"></path>
                        </svg>
                    </button>
                </td>
                <td>
